...
@export var dialog_timeline1: String = "factory_anime0index1"
@export var dialog_timeline2: String = "factory_anime0index2"
@export var dialog_timeline3: String = "factory_anime0index3"
@export var dialog_timeline3m: String = "factory_anime0index3m"
