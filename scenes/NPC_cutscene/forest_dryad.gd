...
@export var dialog_timeline1: String = "forest_trent1"
@export var dialog_timeline2: String = "forest_trent2"
@export var dialog_timeline3: String = "forest_trent3"
#@export var dialog_timeline3c: String = "tromarvelia_beast3c"
...
func _process(delta):
	...
	if Global.route_status == "Cyber"  or (Global.timeline >= 6 and Global.timeline < 10):
