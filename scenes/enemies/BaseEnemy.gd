...
@export var attack_range := 60  # Increased range for better responsiveness
@export var enemy_damage := 10
@export var attack_cooldown := 1.0  # Reduced cooldown for faster attacks
...
var gravity = 1000.0  # Changed from const to var

# Attack system - IMPROVED VERSION
...
func _process(delta):
	...
	# Check for attacks during chase - NEW: Attack while chasing
