...
@export var dialog_timeline1: String = "exactlyion_android_girl1"
@export var dialog_timeline2: String = "exactlyion_android_girl2"
@export var dialog_timeline3: String = "exactlyion_android_girl3"
