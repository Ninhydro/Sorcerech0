...
@export var dialog_timeline1: String = "aerendale_man1"
@export var dialog_timeline1_1: String = "aerendale_man1_1"
@export var dialog_timeline2: String = "aerendale_man2"
@export var dialog_timeline2_2: String = "aerendale_man2_2"
@export var dialog_timeline3: String = "aerendale_man3"
...
func _start_dialog():
	...
	if Global.timeline < 6:
			if "Work_here" in Global.npc_choice_memory.get("Worker", {}).values() or "Go_back" in Global.npc_choice_memory.get("Worker", {}).values():
				Dialogic.start(dialog_timeline1_1, false)
				Global.affinity += 1
			else:
				Dialogic.start(dialog_timeline1, false)
	elif Global.timeline >= 6 and Global.timeline < 10:
			if "Work_here2" in Global.npc_choice_memory.get("Worker", {}).values() or "Go_back2" in Global.npc_choice_memory.get("Worker", {}).values():
				Dialogic.start(dialog_timeline2_2, false)
				Global.affinity += 1
			else:
