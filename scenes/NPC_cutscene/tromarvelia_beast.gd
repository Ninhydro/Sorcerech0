...
@export var dialog_timeline1: String = "tromarvelia_beast1"
@export var dialog_timeline2: String = "tromarvelia_beast2"
@export var dialog_timeline3: String = "tromarvelia_beast3"
