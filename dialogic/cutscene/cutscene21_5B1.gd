...
var target_room2 = "Room_AerendaleTown"     # Name of the destination room (node or scene)
...
func _on_body_entered(body):
	...
	# Start your dialog timeline.
		Dialogic.start("timeline21TB1", false)
