...
func _on_body_entered(body):
	print("Cutscene11: Body entered - ", body.name if body else "null")
	
	# Check if timeline condition is met
	if Global.timeline == 6 and body.is_in_group("player"):
		print("Cutscene11: Conditions met, calling parent method")
		...
		print("Cutscene11: Conditions not met. Global.timeline = ", Global.timeline, ", is_player = ", body.is_in_group("player") if body else "false")
...
func _on_cutscene_start():
	...
	if _player_ref:
		...
		print("Cutscene11: Player reference stored: ", player_in_range.name)
...
func _on_cutscene_end():
	...
	print("Cutscene11: Set Global.timeline = ", Global.timeline)
