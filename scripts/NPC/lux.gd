...
@onready var sprite_2d: Sprite2D = $Lux
@onready var animation_player: AnimationPlayer = $Lux/AnimationPlayer
...
@export var dialog_timeline3: String = "lux3"
...
func _process(delta):
	...
	if not visible and Global.timeline >= 10 and Global.persistent_saved_lux == true:
		visible = true
