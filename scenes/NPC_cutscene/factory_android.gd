...
@export var dialog_timeline1: String = "factory_android1"
@export var dialog_timeline2: String = "factory_android2"
@export var dialog_timeline3: String = "factory_android3"
@export var dialog_timeline3m: String = "factory_android3m"
