...
@export var dialog_timeline1: String = "factory_scientist1"
@export var dialog_timeline2: String = "factory_scientist2"
@export var dialog_timeline3: String = "factory_scientist3"
@export var dialog_timeline3m: String = "factory_scientist3m"
