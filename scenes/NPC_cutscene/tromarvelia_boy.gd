...
@export var dialog_timeline1: String = "tromarvelia_boy1"
@export var dialog_timeline1s: String = "tromarvelia_boy1s"
@export var dialog_timeline2: String = "tromarvelia_boy2"
@export var dialog_timeline2s: String = "tromarvelia_boy2s"
@export var dialog_timeline3: String = "tromarvelia_boy3"
@export var dialog_timeline3c: String = "tromarvelia_boy3c"
@export var dialog_timeline3cs: String = "tromarvelia_boy3cs"
	...
	if not visible:
		if Global.timeline < 6:
			...
			if Global.route_status == "Cyber":
				if Global.sword_on_boy:
					visible = true
					animation_player.play("idle2c2")
				elif not Global.sword_on_boy:
					visible = true
...
func _start_dialog():
	...
	if Global.timeline < 6:
		if not Global.has_sword and not Global.sword_on_boy:
			Dialogic.start(dialog_timeline1, false)
		elif Global.has_sword and not Global.sword_on_boy:
			Dialogic.start(dialog_timeline1s, false)
			Global.sword_on_boy = true
			Global.has_sword = false
			Global.affinity -= 2
	# Add to player inventory
			#if "inventory" in Global.player.body:
			Global.player.remove_item_from_inventory("Sword")
				#body.inventory.append(inventory_id)
		elif Global.sword_on_boy and not Global.has_sword:
			Dialogic.start(dialog_timeline1s, false)
