...
@onready var sprite_2d: Sprite2D = $Nora
@onready var animation_player: AnimationPlayer = $Nora/AnimationPlayer
@onready var interaction_area: Area2D = $InteractionArea
@onready var bubble_timer: Timer = $BubbleTimer

# Configuration
@export var dialog_timeline1: String = "nora1"
@export var dialog_timeline2: String = "nora2"
@export var dialog_timeline3: String = "nora3"
...
func _process(delta):
	...
	if not visible and Global.timeline >= 4 and Global.minigame_nora_completed:
		visible = true
