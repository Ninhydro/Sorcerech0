...
@export var dialog_timeline1: String = "forest_cat"
#@export var dialog_timeline2: String = "forest_bluefox2"
#@export var dialog_timeline3: String = "forest_bluefox3"
#@export var dialog_timeline3c: String = "forest_bluefox3c"
