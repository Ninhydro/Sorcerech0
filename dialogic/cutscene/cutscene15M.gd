...
func _process(delta):
	if Global.timeline == 6.5 and Global.meet_gawr == true and Global.after_battle_gawr == false: 
...
func _on_dialogic_finished(_timeline_name = ""):
	...
	if Global.ult_magus_form == true and Global.gawr_dead == true:
	...
	elif Global.ult_magus_form == false and Global.gawr_dead == false:
		pass
