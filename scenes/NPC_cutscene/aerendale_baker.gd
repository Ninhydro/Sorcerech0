...
@export var dialog_timeline1: String = "aerendale_woman1"
@export var dialog_timeline2: String = "aerendale_woman2"
@export var dialog_timeline2m: String = "aerendale_woman2_m"
@export var dialog_timeline2c: String = "aerendale_woman2_c"
@export var dialog_timeline3: String = "aerendale_woman3"
...
func _start_dialog():
	...
	if Global.timeline < 6:
			...
			if "Magus_baker" in Global.npc_choice_memory.get("Baker", {}).values():
				Dialogic.start(dialog_timeline2m, false)
			elif "Cyber_baker" in Global.npc_choice_memory.get("Baker", {}).values():
