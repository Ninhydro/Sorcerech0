...
@export var form_full_sprites: Dictionary = {
	"Normal": preload("res://assets_image/Characters/Phina/potrait_normal.png") if ResourceLoader.exists("res://assets_image/Characters/Phina/potrait_normal.png") else null,
	"Magus": preload("res://assets_image/Characters/Phina/potrait_magus.png") if ResourceLoader.exists("res://assets_image/Characters/Phina/potrait_magus.png") else null,
	"Cyber": preload("res://assets_image/Characters/Phina/potrait_cyber.png") if ResourceLoader.exists("res://assets_image/Characters/Phina/potrait_cyber.png") else null,
	"UltimateMagus": preload("res://assets_image/Characters/Phina/potrait_ultimate_magus.png") if ResourceLoader.exists("res://assets_image/Characters/Phina/potrait_ultimate_magus.png") else null,
	"UltimateCyber": preload("res://assets_image/Characters/Phina/potrait_ultimate_cyber.png") if ResourceLoader.exists("res://assets_image/Characters/Phina/potrait_ultimate_cyber.png") else null,
}
...
func _ready():
	...
	player_sprite_profile.set_custom_minimum_size(Vector2(90, 100))
