...
@onready var sprite_2d: Sprite2D = $Sterling
@onready var animation_player: AnimationPlayer = $Sterling/AnimationPlayer
...
@export var dialog_timeline3: String = "sterling3"
