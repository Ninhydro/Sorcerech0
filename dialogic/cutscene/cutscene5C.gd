...
func _on_body_entered(body):
	...
	if Global.timeline == 4 and Global.meet_valentina_one == false and body.is_in_group("player"):
...
func _setup_cutscene():
	...
	sequence = [
		...
		{"type": "dialog", "name": "timeline6C", "wait": true},
		...
		{"type": "player_animation", "name": "idle",  "wait": false},
		{"type": "dialog", "name": "timeline6C_1", "wait": true},
...
#func _process(delta):
#	if Global.timeline == 4 and Global.meet_valentina_one == false: 
...
#		Dialogic.start("timeline6C", false)
