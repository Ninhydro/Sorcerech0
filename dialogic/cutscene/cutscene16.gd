...
func _on_body_entered(body):
	...
	if Global.timeline == 6.5 and Global.ult_cyber_form == true and Global.ult_magus_form == true and body.is_in_group("player"):
...
func _setup_cutscene():
	...
	sequence = [
		...
		{"type": "dialog", "name": "timeline16_8", "wait": true},
