...
@export var dialog_timeline1: String = "tromarvelia_soldier1"
@export var dialog_timeline1m: String = "tromarvelia_soldier1m"
@export var dialog_timeline1c: String = "tromarvelia_soldier1c"
@export var dialog_timeline2: String = "tromarvelia_soldier2"
@export var dialog_timeline2m: String = "tromarvelia_soldier2m"
@export var dialog_timeline2c: String = "tromarvelia_soldier2c"
@export var dialog_timeline3: String = "tromarvelia_soldier3"
@export var dialog_timeline3c: String = "tromarvelia_soldier3c"
...
func _start_dialog():
	...
	if Global.timeline < 6:
			if "Magus_Magus Soldier" in Global.npc_choice_memory.get("Magus Soldier", {}).values():
				Dialogic.start(dialog_timeline1m, false)
			elif "Cyber_Magus Soldier" in Global.npc_choice_memory.get("Magus Soldier", {}).values():
			...
			if "Magus_Magus Soldier2" in Global.npc_choice_memory.get("Magus Soldier", {}).values():
				Dialogic.start(dialog_timeline2m, false)
			elif "Cyber_Magus Soldier2" in Global.npc_choice_memory.get("Magus Soldier", {}).values():
