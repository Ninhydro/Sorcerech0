...
@onready var sprite_2d: Sprite2D = $Varek_soldier
@onready var animation_player: AnimationPlayer = $Varek_soldier/AnimationPlayer
...
@export var dialog_timeline3: String = "varek2"
